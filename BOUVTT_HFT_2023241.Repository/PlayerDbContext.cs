...
namespace BOUVTT_HFT_2023241.Repository
{
    public class PlayerDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                new Training("1*Running Training*2023.11.01*1*10"),
                new Training("2*Forward Training*2023.11.05*2*7"),
                new Training("3*Personal Training*2023.10.24*3*9"),
                new Training("4*VOD review*2023.11.02*4*3"),
                new Training("5*Center Traning*2023.11.17*5*8"),
                new Training("6*Lifting*2023.11.08*6*10"),
                new Training("7*Guard Training*2023.11.07*7*6"),
                new Training("8*Center Training*2023.11.13*8*8"),
                new Training("9*Talk-over*2023.11.20*9*1"),
                new Training("10*Talk-over*2023.11.07*10*2"),
                new Training("11*Positional Training*2023.11.12*11*5"),
                new Training("12*Running Training*2023.11.23*12*10"),
                new Training("13*3-Point Training*2023.10.20*13*4"),
                new Training("14*Free Throw Training*2023.11.04*14*2"),
                new Training("15*Floater Training*2023.11.16*15*1"),
                new Training("16*Personal Training*2023.11.21*16*9"),
                new Training("17*Guard Training*2023.11.09*17*6"),
                new Training("18*Center Training*2023.11.10*18*8"),
                new Training("19*VOD review*2023.11.01*19*3"),
                new Training("20*3-Point Training*2023.11.17*20*4"),
